      ...
      <footer className="footer">
        <div className="footer__inner">
          ...
          <nav className="footer__social" aria-label="Redes sociais">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="18" height="18" aria-hidden="true">
                <path fill="currentColor" d="M0 1.146C0 .513.526 0 1.175 0h.65C2.474 0 3 .513 3 1.146v.708C3 2.487 2.474 3 1.825 3h-.65C.526 3 0 2.487 0 1.854v-.708ZM0 4.5h3v11H0v-11ZM5 4.5h2.839v1.561h.04c.396-.75 1.368-1.541 2.817-1.541C13.6 4.52 15 5.88 15 8.475V15.5h-3v-6.16c0-1.468-.525-2.469-1.838-2.469-.999 0-1.593.675-1.854 1.326-.096.234-.12.562-.12.892V15.5H5v-11Z"/>
              </svg>
            </a>
          </nav>
        </div>
